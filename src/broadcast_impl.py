#-----------------------------------------------------------------------------
# Implementation of class Broadcast. See broadcast.py for details.
#
...
class Broadcast:
  ...
  def update_display(self):
    ...
    if self._display:
      ...
      ttr = getattr(self._display,"time_to_refresh",0)
      if ttr:
        g_logger.print(f"waiting another {ttr}s for display")
        TimeSleep.light_sleep(ttr)
